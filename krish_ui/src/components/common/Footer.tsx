        ...
        <footer className="relative overflow-hidden bg-[#050403]">
            ...
            <div className="relative z-10 mx-auto max-w-[1400px] px-6 pb-10 pt-20 md:px-10 md:pt-24">
                <div className="grid grid-cols-1 gap-10 border-b border-primary/10 pb-14 text-center sm:grid-cols-2 sm:text-left lg:grid-cols-[1.35fr_0.9fr_0.9fr_1fr]">
                    ...
                    <div className="space-y-4">
                        ...
                        <nav className="flex flex-col space-y-3 text-xs font-medium uppercase tracking-[0.18em] text-cream/60">
                            <a href="/treatments" className="transition-colors hover:text-primary">Korean Facials</a>
                            <a href="/treatments" className="transition-colors hover:text-primary">Clear Skin Therapy</a>
                            <a href="/treatments" className="transition-colors hover:text-primary">Hydra Infusion</a>
                        </nav>
                    </div>
                    ...
                    <div className="space-y-4">
                        <h4 className="text-[10px] font-bold uppercase tracking-[0.34em] text-primary">Visit &amp; Connect</h4>
                        <p className="text-sm leading-7 text-cream/60">
                            Panipat and Karnal skin clinic.
                        </p>
                        <div className="flex flex-col space-y-1 text-xs text-cream/80">
                            <a href="tel:7988106343" className="hover:text-primary transition-colors">📞 +91 79881 06343</a>
                            <a href="mailto:krisharora3406@gmail.com" className="hover:text-primary transition-colors">✉️ krisharora3406@gmail.com</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-8 flex flex-col gap-3 text-center text-[9px] uppercase tracking-[0.3em] text-cream/30 md:flex-row md:items-center md:justify-between md:text-left">
                    <p>Copyright 2026 De Royal Kore</p>
