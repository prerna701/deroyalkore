    ...
    return (
        <div className="min-h-screen bg-[#FDFBF7] pt-32 pb-20">
            ...
            <div className="max-w-5xl mx-auto px-6 md:px-10">
                <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#F2E9D8] via-[#EADBCA] to-[#D9A577] shadow-2xl border border-[#D9A577]/30">
                        ...
                        <div className="lg:w-1/2 p-10 lg:p-14 flex flex-col justify-center">
                            ...
                            <div className="space-y-4 mb-8">
                                <div className="flex items-start">
                                    ...
                                    <p className="font-sans text-lg text-[#5D4634] font-medium">Full Treatment in just <span className="font-bold text-[#3A2D23] text-xl border-b-2 border-[#3A2D23]">₹3500</span></p>
                                </div>
                                <div className="flex items-start">
                                    <span className="material-symbols-outlined text-[#3A2D23] mr-3 mt-1">redeem</span>
                                    <p className="font-sans text-lg text-[#5D4634] font-medium">Includes <span className="font-bold text-[#3A2D23]">1 Month Free</span> After-Care Products</p>
                                </div>
                            </div>

                            <p className="font-sans text-xl italic text-[#5D4634] mb-10 leading-relaxed">
                                Achieve that flawless, radiant, and luminous glass-like finish with our highly requested intensive hydration and rejuvenation protocol.
                            </p>

                            <GlossyButton onClick={() => navigate('/treatment/korean-glass-skin')}>
                                Book Now
                            </GlossyButton>
                        </div>
                    </div>
